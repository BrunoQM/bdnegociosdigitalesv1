...
insert into producto1
values(2, 'Tupsi pop', 'Dulce re-sano para el diente', 100, 60, 5);

insert into producto1
values(3, 'Plancha', 'plancha facil el suit', 234.5, 134, 2);
...
![Diagrama resultante](/Unidad1/img/diagrama1.png)